...
<div class="container" id="page">
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			...
			//	array('label'=>'Contact', 'url'=>array('/site/contact')),
				array('label'=>'Propostas', 'url'=>array('/propostas')),
				array('label'=>('Lista de Servicos'), 'url'=>array('/CatalogoServicos')),
				array('label'=>'Forma de Pagamento', 'url'=>array('/FormaPgto')),
				array('label'=>'Tabela de Valores', 'url'=>array('/TabelaValores')),
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> Nome_empresa.<br/>
